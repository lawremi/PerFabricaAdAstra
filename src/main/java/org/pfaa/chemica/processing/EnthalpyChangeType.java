...
public interface EnthalpyChangeType extends UnitOperationType<IndustrialMaterial, EnthalpyChange> {
	enum Direction {
		GAIN,
		LOSS;
	}
	...
	enum EnthalpyChangeTypes implements EnthalpyChangeType {
		...
		@Override
		public EnthalpyChange of(MaterialStoich<IndustrialMaterial> input) {
			return new EnthalpyChange(this, input);
		}
	}

	public EnthalpyChangeType.Axis getAxis();
	public State getInputState();
	public State getOutputState();
	public EnthalpyChangeType.Direction getDirection();
}