	...
	public static enum Compounds implements Compound {
	    ...
	    CoO(new Formula(Co, O), "cobalt", 
			new Solid(Color.black, 6.44, 
					  ...
					  new Hazard(2, 0, 0)),
					  new Fusion(2103)),
		Cu2CO3OH2(new Formula(Cu._(2), new Part(C, O._(3)), new Part(O, H)._(2)), "copper",
	    ...
	    Cu2O(new Formula(Cu._(2), O), "copper",
		...
		FeCr2O4(new Formula(Fe, Cr._(2), O._(4)), "chromium", 
				...
				new Fusion(2500)),
		FeNb2O6(new Formula(Fe, Nb._(2), O._(6)), "niobium", 
		...
		FeTa2O6(new Formula(Fe, Ta._(2), O._(6)), "tantalum", 
