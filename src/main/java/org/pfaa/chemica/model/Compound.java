...
public interface Compound extends Chemical {
	public static enum Compounds implements Compound {
		...
		NH3(new Formula(Element.N, Element.H._(3)), "ammonia", 
		...
		Na2O(new Formula(Na._(2), O), null,
			 ...
			 new Fusion(1405)),
		Na2SO4(new Formula(Na._(2), SO4), null,
		...
		Na2SO4_10H2O(new Formula(Na._(2), SO4).hydrate(10), null,
		...
		ZnCl2(new Formula(Zn, Cl._(2)), null,
			  new Solid(2.91,
		...
		PROPENE(new Formula(Element.C._(3), Element.H._(6)).setSmiles("cc=c"), null, 
				new Solid(),
				new Fusion(88),
		...
		N_BUTENE(new Formula(Element.C._(4), Element.H._(8)).setSmiles("c/(c=c)\\c"), "butene", /* cis-2-butene */ 
		...
		ISO_BUTENE(new Formula(Element.C._(4), Element.H._(8)).setSmiles("cc(=c)c"), "butene",
		...
		BUTADIENE(new Formula(Element.C._(4), Element.H._(6)).setSmiles("c=cc=c"), null, /* 1,3-butadiene */ 
				  new Solid(),
				  new Fusion(164),
		...
		BENZENE(new Formula(Element.C._(6), Element.H._(6)).setSmiles("c1ccccc1"), null, 
		...
		TOLUENE(new Formula(Element.C._(7), Element.H._(8)).setSmiles("Cc1ccccc1"), null, 
