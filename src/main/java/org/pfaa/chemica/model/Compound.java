...
public interface Compound extends Chemical {
	public static enum Compounds implements Compound {
		...
		NaCaNb2O6OH(new Formula(Na, Ca, Nb._(2), O._(6), new Part(O, H)), null, new Solid()),
	    NaCaTa2O6OH(new Formula(Na, Ca, Ta._(2), O._(6), new Part(O, H)), null, new Solid()),
