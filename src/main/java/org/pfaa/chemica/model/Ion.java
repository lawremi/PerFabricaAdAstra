...
public interface Ion extends PartFactory {
	...
	public enum Ions implements Ion {
		...
		Co(Element.Co, +2, new Thermo(-58.2, -113)),
		Cs(Element.Cs, +1, new Thermo(-258, 133)),
		Cu(Element.Cu, +2, new Thermo(64.8, -99.6)),
		Fe_2(Element.Fe, +2, new Thermo(-89.1, -138)),
		Fe_3(Element.Fe, +3, new Thermo(-48.5, -316)),
		...
		Mn(Element.Mn, +2, new Thermo(-221, -73.6)),
		Mo(Element.Mo, +4, null),
		Na(Element.Na, +1, new Thermo(-240, 59)),
		Ni(Element.Ni, +2, new Thermo(-54, -129)),
		...
		CrO4(new Formula(Element.Cr, Element.O._(4)), -2, null),
