...
**** Copper
     ...
     * 3x :: ore =crush=> 2*ore_crushed =float=> 1.5*chalcopyrite_dust =smelt=> Cu
...
** Reactions
   ...
   We might not need to actually have a Reation
...
** Processes
   ...
   ItemStack should be registered under a single dictionary term, so
   we will need additional means of abstraction.
