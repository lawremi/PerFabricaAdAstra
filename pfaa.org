...
**** Health
     ...
     * Level 4: like burning in lava (must drink milk to stop)
     ...
     world. Ingestion of liquids should magnify effects. If marked as
     poisonous, poison effect obviously applies always.

     Liquid Contact:
     * Level >=2: Instant damage
     * Level >=3: Poison effect
     * Level >=4: Increased poison effect, usually lethal
     
     Liquid ingestion (drinking a potion):
     * Level >=1: Nausea
     * Level >=2: Nausea + instant damage
     * Level >=3: Nausea + poison effect  
     * Level >=4: Nausea + increased poison effect, usually lethal
     
     Gas inhalation (immediately upon contact):
     * Level >=2: Nausea
     * Level >=3: Nausea + poison effect  
     * Level >=4: Nausea + increased poison effect, usually lethal
