...
**** Uranium
     ...
     For enrichment, the UF4 is instead oxidized with fluorine to
     UF6 and purified by fractional distillation. UF6 then is brought
     back to UO2 by reacting as a gas with water vapor to UO2F2-H2O,
     which is reduced with H2 gas to UO2.
