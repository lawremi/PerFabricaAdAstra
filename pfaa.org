...
*** Two-stage design
    * The first stage is crushing, while the second is
      ...
      * Raw ore =crush=> crushed ore =pulverize=> dust.
    * Crushing ore yields 2 crushed ore, and the host rubble/gravel is
      kept if the machine supports more outputs.
    * Crushed ore is pulverized to 1 primary dust + others according
      to weight, limited by the machine outputs.
    * Crushing cobblestone is same, but rubble instead of crushed ore,
      and primary dust is sand. A pure crusher will yield gravel from
      the rubble.
...
* Mod Integration
  ...
  | Magneticraft  | Crusher, Grinder (2,%) |
  | Mekanism      | Crusher, E-chamber (1) |
  | BC+           | Duster (1)             |
  | ELN           | ?                      |
