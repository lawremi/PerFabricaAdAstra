...
*** Genetics ideas
    ...
    the wild crop path (along the lines of PHC bushes), then breeding
    would be about improving crop traits, as well as mutating between
    species.  Generating realistic, edible, non-crop plants, is also
...
*** TODO Test realgar and pyrite generation
