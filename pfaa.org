...
**** Hydrogen sources
     ...
     * H2O electrolysis
     * Partial oxidation of coal or CH4 (2CH4 + O2 => 2CO + 4H2)
...
**** Steam reforming
     ...
     CH4 + H2O(g) => CO + 3H2 (syngas)

     The syngas is separated using PSA (pressure swing
     adsorption). The left-over CO can extract more H2 from steam
     using a gas-shift reaction (see below).
     
**** (Low-temperature) Gas-shift
     Produces H2 from the CO left over from steam reforming.
     At 300 C, with CuO+ZnO+Al2O3 (equal parts) catalyst,
